...
//                           forCellReuseIdentifier: "AnimalTableViewCell")
        tableView.register(nibWithClass: AnimalTableViewCell.self)
...
//                           forHeaderFooterViewReuseIdentifier: "AnimalTableViewHeaderFooterView")
        tableView.register(headerFooterViewWithClass: AnimalTableViewHeaderFooterView.self)
...
//        }
        ...
        if let headerView = tableView.dequeueReusableHeaderFooterView(withClass: AnimalTableViewHeaderFooterView.self) {
            headerView.descriptionLabel.text = "\(dictionaries[section].firstLetter) - Header"
            return headerView
        }
...
//        }
        ...
        if let footerView = tableView.dequeueReusableHeaderFooterView(withClass: AnimalTableViewHeaderFooterView.self) {
            footerView.descriptionLabel.text = "\(dictionaries[section].firstLetter) - Footer"
            return footerView
        }
...
//        return UITableViewCell()
        ...
        let cell = tableView.dequeueReusableCell(withClass: AnimalTableViewCell.self, for: indexPath)
        cell.animal = dictionaries[indexPath.section].list[indexPath.row]
