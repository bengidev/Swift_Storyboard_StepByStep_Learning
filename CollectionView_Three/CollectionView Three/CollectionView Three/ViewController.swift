...
final class ViewController: UIViewController {
    ...
    private func setupCollectionView() -> Void {
        ...
        collectionView.register(UINib(nibName: "AnimalCollectionViewCell", bundle:
                                        Bundle(for: AnimalCollectionViewCell.self)),
                                forCellWithReuseIdentifier: "AnimalCollectionViewCell")
    }
